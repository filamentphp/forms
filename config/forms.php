...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Get Temporary URL. this is useful if you are uploading objects to s3
    | and using cloudfront to retrieve it.
    |
    */
    'temporary_signed_url' => env('FORMS_TEMPORARY_URL',true),
    /*
    |--------------------------------------------------------------------------
    | Dark mode
    |--------------------------------------------------------------------------
